...
urlpatterns = [
    ...
    url(r'^rummage_item/(?P<rummageItemId>\d+)/$', app.views.rummage_item, name='rummage_item'),
    ...
    url(r'^rummage_item_note/(?P<rummageItemId>\d+)/$', app.views.rummage_item_note, name='rummage_item_note'),
